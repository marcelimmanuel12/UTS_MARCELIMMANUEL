...
class FakultasResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('name_fakultas')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('code_fakultas')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('Dekan_fakultas')
                    ->required()
                    ->maxLength(255),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name_fakultas')
                    ->searchable(),
                Tables\Columns\TextColumn::make('code_fakultas')
                    ->searchable(),
                Tables\Columns\TextColumn::make('Dekan_fakultas')
                    ->searchable(),
